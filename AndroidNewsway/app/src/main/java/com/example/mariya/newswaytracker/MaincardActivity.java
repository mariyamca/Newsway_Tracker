...
public class MaincardActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pay = findViewById(R.id.btnok1);
        pay.setOnClickListener(this);
        cancel = findViewById(R.id.btncancel1);
        cancel.setOnClickListener(this);
        cardno = findViewById(R.id.edtcrdno1);
        mm = findViewById(R.id.edtmm1);
        yy = findViewById(R.id.edtyy1);
        cvv = findViewById(R.id.edtcvv1);
    ...
    private class updatedata extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String s) {
            ...
            Toast.makeText(MaincardActivity.this, "Payment Succesfull", Toast.LENGTH_SHORT).show();
