...
public final class Payment_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("       <h2 align=\"center\" >Payment</h2>&nbsp;\n");
      out.write("       <br>\n");
      out.write("    <br>\n");
      out.write("        <form>\n");
      out.write("        \n");
      ...
      out.write("    ");
        ...
        if(request.getParameter("noti_id")!=null){
            String desc="Pay Your Bill";
            String noti="insert into tbl_notify(notify_date,notify_time,notify_msg,custrg_id)values(curdate(),curtime(),'"+desc+"','"+request.getParameter("noti_id")+"')";
      ...
      out.print(stat);
      out.write("</td>\n");
      out.write("                <td><a href=\"Payment.jsp?noti_id=");
      out.print(r.getString("custreg_id"));
      out.write("\">Notify</a></td>\n");
      out.write("                \n");
      out.write("            </tr>\n");
      out.write("            \n");
      out.write("            ");
