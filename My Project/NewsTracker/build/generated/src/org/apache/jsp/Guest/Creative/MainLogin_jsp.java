...
public final class MainLogin_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("                                                        <li><a href=\"MainLogin.jsp\">Home</a></li>\n");
      out.write("\t\t\t\t\t\t\t\t\n");
      out.write("\t\t\t\t\t\t\t\t\n");
      out.write("\t\t\t\t\t\t\n");
      out.write("\t\t\t\t\t\t\t   <!-- Dropdown -->\n");
      ...
      out.write("\t\t\t\t\t\t\t        <a class=\"dropdown-item\" href=\"\">0471-85963214789</a>\n");
      out.write("\t\t\t\t\t\t\t        <a class=\"dropdown-item\" href=\"\">471-896245856322</a>\n");
      out.write("\t\t\t\t\t\t\t      </div>\n");
      out.write("\t\t\t\t\t\t\t    </li>\t\t\t\t\t\t\t\t\t\n");
      out.write("\t\t\t\t\t\t    </ul>\n");
      out.write("\t\t\t\t\t\t  </div>\t\t\t\t\t\t\n");
      ...
      out.write("\t\t\t\t\t\t\t</h1>\n");
      out.write("                                                    <h2> <a href=\"../../Guest/Login_v16/Index.jsp\" class=\"primary-btn2 header-btn text-uppercase\">LOGIN!</a></h2>\n");
      out.write("\t\t\t\t\t\t</div>\t\t\t\t\t\t\t\t\t\t\t\t\n");
      out.write("\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t</div>\n");
      out.write("\t\t\t</section>\n");
