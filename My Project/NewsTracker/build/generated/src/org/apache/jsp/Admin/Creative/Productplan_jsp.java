...
public final class Productplan_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("        <title>Productplan Page</title>\n");
      out.write("    </head>\n");
      out.write("    \n");
      out.write("     <style>\n");
      ...
      out.write("        <table>\n");
      out.write("         <h2 align=\"center\" >PRODUCT PLAN</h2>\n");
      out.write("         <br>\n");
      out.write("         <br>\n");
      out.write("  <form >\n");
      out.write("      <div>\n");
      out.write("          <label for=\"prodt\" id=\"lab\">Product</label>\n");
      out.write("      <select  name=\"prodt\">\n");
      ...
      out.write("            \n");
      out.write("       <option ");
 if(itemid.equals(rs.getString("product_id"))){
      out.write("selected=\"\"");
}
      out.write(" value=\"");
      ...
      out.write("        <div>\n");
      out.write("     \n");
      out.write("            <label for=\"plan\" id=\"lab\">Plan</label> &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp\n");
      out.write("      <select  name=\"plan\">\n");
      out.write("      <option seleccted=\"selected\"value=\"\">Select</option>\n");
      out.write("    \n");
      out.write("         ");
      ...
      out.write("            \n");
      out.write("       <option ");
 if(planid.equals(r.getString("plan_id"))){
      out.write("selected=\"\"");
}
      out.write(" value=\"");
      out.print(r.getString("plan_id"));
      out.write('"');
      out.write('>');
      out.print(r.getString("plan_type"));
      out.write("</option>\n");
      out.write("            ");
      ...
      out.write("        </div>\n");
      out.write("        <div>\n");
      out.write("            <label for=\"fname\" id=\"lab\">Plan Rate</label>\n");
      ...
      out.write("        <th id=\"head\">Plan Rate</th>\n");
      out.write("        <th id=\"head\">Product Name</th>\n");
      out.write("        <th id=\"head\">Plan</th>\n");
      out.write("    <th></th>\n");
      out.write("    <th></th>\n");
      out.write("    </tr>\n");
      out.write("    \n");
      ...
      out.write("</td>\n");
      out.write("                <td>");
      out.print(m.getString("product_name"));
      out.write("</td>\n");
      out.write("                <td>");
      out.print(m.getString("plan_type"));
      out.write("</td>\n");
      out.write("              <td><a href=\"Productplan.jsp?delid=");
      out.print(m.getString("prodplan_id"));
      out.write("\"><img src=\"Design/Icons/delete.png\" width=\"25\" height=\"20\"></a></td>\n");
      out.write("              <td><a href=\"Productplan.jsp?editid=");
      out.print(m.getString("prodplan_id"));
      out.write("\"><img src=\"Design/Icons/edit.png\" width=\"25\" height=\"20\"></a></td>\n");
      out.write("                \n");
      out.write("            </tr>\n");
      out.write("            \n");
      out.write("            ");
